...
def configure_host_logging() -> None:
    """Enable Host validation logs in the UI server terminal."""
    level_name = os.environ.get('HOST_LOG_LEVEL', 'INFO').upper()
...
if __name__ == '__main__':
    ...
    connect_host = 'localhost' if host == '127.0.0.1' else host
